...
CREATE TABLE apl_cadastro.tab_produto (
	id                          serial4                         NOT NULL,
	nome                        varchar(50)                     NOT NULL,
	nome_abreviado              varchar(25)                     NOT NULL,
	unid_embalagem              varchar(12)                         NULL,
	cod_barras                  varchar(15)                         NULL,
	sku                         varchar(15)                         NULL,
	vl_produto                  numeric(13,4)                   NOT NULL,
	tx_liquidacao               numeric(4,2)                    NOT NULL,
	saldo                       numeric(13,4)                   NOT NULL,
	fl_excluido                 bool                            NOT NULL,
...
CREATE TABLE apl_contrato.tab_contrato_forma_pagamento (
	id                          serial4                         NOT NULL,
	...
	CONSTRAINT fk_contratos_contrato_meio_pagamento_contrato    FOREIGN KEY (contrato_id)                       REFERENCES apl_contrato.tab_contrato(id),
	CONSTRAINT ck_contratos_contrato_meio_pagamento_tipo        CHECK (meio_pagto                               in ('A','B','C','D','X','Z'))
);

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- MÓDULO : apl_finaceiro						DESCRIÇÃO: Módulo contendo tabelas para registrar lançamentos da transações, pagamentos e parcelamentos
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

CREATE SCHEMA apl_finaceiro;


CREATE TABLE apl_finaceiro.tab_transacao (
	id                          serial4                         NOT NULL,
	tipo                        char(1)                         NOT NULL,
...
CREATE TABLE apl_finaceiro.tab_pagamento (
	id                          serial4                         NOT NULL,
	...
	CONSTRAINT fk_financeiro_pagamento_transacao               FOREIGN KEY (transacao_id)               REFERENCES apl_finaceiro.tab_transacao(id),
...
CREATE TABLE apl_finaceiro.tab_parcelamento (
	id                          serial4                         NOT NULL,
	transacao_id                int4                                NULL,
	...
	CONSTRAINT fk_financeiro_parcelamento_transacao             FOREIGN KEY (transacao_id)               REFERENCES apl_finaceiro.tab_transacao(id),
	CONSTRAINT ck_financeiro_parcelamento_meio_pagamento        CHECK (meio_pagto                        in ('A','B','C','D','W','X','Y','Z'))
);

CREATE TABLE apl_finaceiro.tab_parcelamento_parcela (
	id                          serial4                         NOT NULL,
	...
	CONSTRAINT fk_financeiro_lancto_parc_lancto                FOREIGN KEY (parc_lancto_id)            REFERENCES apl_finaceiro.tab_parcelamento(id)

);
CREATE TABLE apl_finaceiro.tab_parcelamento_parcela_pagto (
	id                          serial4                         NOT NULL,
	cpt_competencia         int4                            NOT NULL,
	...
	CONSTRAINT fk_financeiro_lancto_parcela_pagto_parcel       FOREIGN KEY (parcela_id)            REFERENCES apl_finaceiro.tab_parcelamento_parcela(id),
	CONSTRAINT fk_financeiro_lancto_parcela_pagto_parcelto     FOREIGN KEY (parcelamento_id)       REFERENCES apl_finaceiro.tab_parcelamento(id),
