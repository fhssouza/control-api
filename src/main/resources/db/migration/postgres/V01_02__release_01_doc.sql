...
COMMENT ON COLUMN apl_cadastro.tab_marca.fl_excluido                                             IS 'Verifica se está excluido';
...
COMMENT ON COLUMN apl_cadastro.tab_categoria.fl_excluido                                             IS 'Verifica se está excluido';
...
COMMENT ON COLUMN apl_cadastro.tab_modelo.fl_excluido                                             IS 'Verifica se está excluido';
...
COMMENT ON COLUMN apl_cadastro.tab_unid_medida.fl_embalagem                                       IS 'Determina se a unidade de medida é considerada embalagem';
COMMENT ON COLUMN apl_cadastro.tab_unid_medida.fl_excluido                                        IS 'Determina uma exclusão lógica do registro';
...
COMMENT ON COLUMN apl_cadastro.tab_produto.fl_excluido                                             IS 'Verifica se está excluido';
COMMENT ON COLUMN apl_cadastro.tab_produto.nome_abreviado                                          IS 'Nome do produto abreviado';
COMMENT ON COLUMN apl_cadastro.tab_produto.unid_embalagem                                          IS 'Unidade de embalagem do produto';
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- TABELA : apl_contrato.tab_contrato_form_pagamento	DESCRIÇÃO: Tabela de armazenamento de meios de pagamento de contrato
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
COMMENT ON TABLE apl_contrato.tab_contrato_forma_pagamento                                          IS 'Tabela de armazenamento de meios de pagamento de contrato';

COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.id                                      IS 'Identificador único da forma de pagamento de contrato';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.meio_pagto                              IS 'Meio de do pagamento';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.vl_original                             IS 'Valor original';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.tx_meio_pagto                           IS 'Valor da taxa';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.vl_pago                                 IS 'Valor do pagamento';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.vl_parcela                              IS 'Valor da parcela';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.num_parcelas                            IS 'Numero de parcelas';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.dt_pri_vencto                           IS 'Data do primeiro vencimento';
COMMENT ON COLUMN apl_contrato.tab_contrato_forma_pagamento.contrato_id                             IS 'Identificador da tabela contrato';
