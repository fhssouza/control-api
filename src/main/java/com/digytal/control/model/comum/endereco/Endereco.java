...
public class Endereco {
    @Schema(description="cep do endereço no cadastro", minLength = 11,maxLength = 11, example = "cep:64000110")
    @Column(name = "end_cep")
    private String cep;
    @Schema(description="logradouro do endereço no cadastro", maxLength = 50,example = "logradouro:PRACA DA SE")
    @Column(name = "end_logradouro")
    private String logradouro;
    @Schema(description="número do endereço no cadastro", maxLength = 50,example = "numero:123-A")
    @Column(name = "end_numero")
    private String numero;
    @Schema(description="bairro do endereço no cadastro", maxLength = 50,example = "bairro:CENTRO")
    @Column(name = "end_bairro")
    private String bairro;
    @Schema(description="complemento do endereço no cadastro", maxLength = 50,example = "complemento:BL-A AP-121")
