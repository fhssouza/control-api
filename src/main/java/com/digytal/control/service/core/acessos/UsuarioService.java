...
public class UsuarioService {
    ...
    public CredencialResponse solicitarNovaSenha(String login) {
        ...
        CredencialResponse response = solicitarNovaSenha(entity.getId());
        return response;
    }

        @Transactional
    public CredencialResponse solicitarNovaSenha(Integer id){
        try {
    ...
    @Transactional
    public SessaoResponse alterarSenha(Long expiracao, SenhaRequest request) {
